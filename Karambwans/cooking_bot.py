...
def main_loop(max_loops=50):
    ...
    for loop in range(1, max_loops + 1):
        ...
        bank_close_button = si.find_image_cv2("Karambwans/bank_close.png", threshold=0.95)
        ...
        withdraw_karambwan_success = si.click_image_cv2_without_moving("Karambwans/raw_karambwan.png",
        ...
        bank_close_click = si.click_image_cv2_without_moving("Karambwans/bank_close.png",
        ...
        while True:
            ...
            if monitor.wait_for_condition(timeout=64):
                ...
                monitor.stop()
                raw_still_exists = si.find_image_cv2("Karambwans/raw_karambwan.png",
                                                     threshold=0.98)
                if raw_still_exists:
        ...
        burnt_click = si.click_image_cv2_without_moving("Karambwans/burnt_karambwan.png",
        ...
        cooked_click = si.click_image_cv2_without_moving("Karambwans/cooked_karambwan.png",
                                                         region=bag_region, confidence=0.98, offset_range=(0, 2))
        if cooked_click:
