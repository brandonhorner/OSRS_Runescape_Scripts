...
# This script will work in front of any bank chest that's colored with teal pixels (00FFFF).  You will need
# to place vials of water and harralander in the first bank page you have for the bot to see.
