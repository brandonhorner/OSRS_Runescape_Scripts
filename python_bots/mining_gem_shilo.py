...
def test_zoom_in():
    ...
    print("Test 1: zoom_in(times=1, scroll_amount=5)")
    si.zoom_in(times=1, delay_low=delay[0], delay_high=delay[1], scroll_amount=5)
    time.sleep(wait)
    print("  Resetting: zoom out...")
    si.zoom_out(times=5, delay_low=delay[0], delay_high=delay[1], scroll_amount=-400)
    time.sleep(wait)

    print("Test 2: zoom_in(times=2, scroll_amount=5)")
    ...
    print("Test 3: zoom_in(times=8, delay_low=.1, delay_high=.12, scroll_amount=1)")
